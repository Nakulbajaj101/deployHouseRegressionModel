...
def drop_na_inputs(*, input_data: pd.DataFrame) -> pd.DataFrame:
    """Check model inputs for na values and filters."""

    validated_data = input_data.copy()
    # manage new variables that will enter in test set as null
    new_vars_with_na = [
        var
    ...
    validated_data.dropna(subset=new_vars_with_na, axis=0, inplace=True)
